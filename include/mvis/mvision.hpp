...
MVView *MV_message(MVView *view,ulong what,ulong command,const void *info = NULL);
void MV_postMessage(MVView *view,ulong what,ulong command,const void *info = NULL);
